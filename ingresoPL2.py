...
with open ('C:\\Users\\scamero\\Desktop\\archivo_empresas.txt', 'w') as archivo_empresas:
...
with open ('C:\\Users\\scamero\\Desktop\\archivo_conductores.txt', 'w') as archivo_conductores:
...
with open ('C:\\Users\\scamero\\Desktop\\archivo_vehiculos.txt', 'w') as archivo_vehiculos:
...
with open ('C:\\Users\\scamero\\Desktop\\archivo_bultos.txt', 'w') as archivo_bultos:
    for i in range(20000000):  # Generar datos para 20,000,000 de bultos
        ...
        id_cliente_clientes = random.randint(1, 2000000)  # ID de cliente aleatorio
        # Escribir en el archivo
...
with open ('C:\\Users\\scamero\\Desktop\\archivo_clientes.txt', 'w') as archivo_clientes:
